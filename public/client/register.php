...
<body >
    <div class="leftside">
        <div style="height: 50px; padding: 15px;">
            <label style="font-size: 30px; font-weight: 600; text-decoration: underline;">SC Fashion</label>
        </div>
        <div>
            <form action="../../php/client/register.php" method="post" name="registerForm" autocomplete="off">
                <div class="regform">
