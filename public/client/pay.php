...
<body bgcolor="#eeeedd" style="color: #333333;">
    <nav>
        <div style="display: flex;">
            <label style="font-size: 30px; font-weight: 600;"><a href="../client/home.php" style="color: black;">SC Fashion</a></label>
        </div>
        <div>
            <ul style="display: flex; flex-direction: row; gap: 50px;">
                <li><a href="#" class="list">Home</a></li>
                <li><a href="#" class="list">Collection</a></li>
                <li><a href="#" class="list">Specials</a></li>
